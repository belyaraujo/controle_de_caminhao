    ...
    <div class="container">
        <div class="mh-100" style="width: 1000px; height: 1000px;">
            <div class="card border-dark" style="max-width: 700rem;">
                <div class="card-header text-white" style="background-color: #044f84;">Emissão de relatório - Visitante<div
                ...
                <div class="card-body text-dark">
                    <p class="card-text">
                        ...
                        <!-- Setor-->
                    <form action="{{ route('gera-pdf2') }}" method="GET">
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control" name="id_placa" id="id_placa">
                                ...
                                @foreach ($placa as $placa)
                                    <option value="{{ $placa->placa }}">{{ $placa->placa}}
                                    </option>
                                @endforeach
                            </select>
                        </div>
